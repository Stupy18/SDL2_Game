...
// GameStateManager::GameStateManager(RenderWindow& wnd)
//     : window(wnd), gameState(GameState::Playing) , player(Vector2f(100, 780), playerTextures, 2.5, WIDTH, HEIGHT) {
//         playerTextures.push_back(window.loadTexture("src/res/images/character_stanga.png"));
//         playerTextures.push_back(window.loadTexture("src/res/images/character_dreapta.png"));
//         player.setFrameSize(80, 80, 0, 0);
// }

// void GameStateManager::initialize_Playing() {
...
//             window.cleanUp();
//             renderDeathScreen();
//             // Check for player input to reset or exit
//             handleDeathScreenState();
//             break;
...
// void GameStateManager::reset_Game() {
//     // Reset player, enemies, bullets, etc.
//     gameState = GameState::Playing;
// }

// void GameStateManager::handleDeathScreenState() {
//     SDL_Event event;
//     while (SDL_PollEvent(&event)) {
//         if (event.type == SDL_QUIT) {
...
//             if (event.key.keysym.sym == SDLK_r) { // Press 'R' to reset
//                 reset_Game();
//             }
//         }
//     }
